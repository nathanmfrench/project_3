...
With more cores, the answer should be computed faster since there are more things getting run in parallel. This idea also applies to having more workers, where there are more computations being done in parallel, leading to shorter runtimes. 
